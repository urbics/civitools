...
use Urbics\Civitools\Console\Migrations\DbConfig;
use Urbics\Civitools\Traits\StatusMessageTrait;
...
class CiviDbSeeder
{
    ...
    public function seed($createTables = false)
    {
        ...
        //TBD: Resolve unbuffered queries error caused by  DROP FUNCTION IF EXISTS `civicrm_strip_non_numeric`;
